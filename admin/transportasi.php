...
if (isset($_POST['add'])) {
    ...
    $harga = $_POST['harga'];
    $status = $_POST['status'];
    $sqlVal = "('".$asal."', '".$harga."', '".$status."')";

    $sql = "SELECT * FROM transportasi WHERE asal = '$asal'";
    $resulta = mysqli_query($db,$sql);
    $datao = $resulta -> fetch_assoc();

    if (empty($datao)) {
        $insert = $db->query("INSERT INTO transportasi (asal, pesawat, status) VALUES $sqlVal");
            if ($insert) {
...
if (isset($_POST['edit'])) {
    ...
    $harga =$_POST['harga'];
    $status =$_POST['status'];
    $inserto = $db->query("UPDATE transportasi SET asal='$asal', pesawat='$harga', status='$status' WHERE id='$id'");
    if ($inserto) {
...
if (isset($_POST['delete'])) {
    ...
    $sqll = "SELECT * FROM transportasi WHERE id = '$iddelete'";
    $resultt = mysqli_query($db,$sqll);
    $dataa = $resultt -> fetch_assoc();

    if (!empty($dataa)) {
    $sqlk = "DELETE FROM transportasi WHERE id = '$iddelete'";
                                ...
                                <div class="modal-body">
                                    <form method="post" action="transportasi.php">
                                        <div class="form-group">
                                            <label for="asal">Daerah Asal</label>
                                            <input type="text" class="form-control" name="asal" value="<?= $row['asal']?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="harga">Harga</label>
                                            <input type="text" class="form-control" name="harga" value="<?= $row['pesawat']?>">
                                        </div>
                                        <?php 
                                            if ($x == "transit") { ?>
                                                <div class="form-group">
                                            <label for="status">Status Transit</label>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="status" id="flexRadioDefault1" value="transit" checked>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Transit
                                            </label>
                                            </div>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="status" id="flexRadioDefault1" value="langsung">
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Langsung
                                            </label>
                                            </div>
                                        ...
                                        <?php
                                            ...
                                            <label for="status">Status Transit</label>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="status" id="flexRadioDefault1" value="transit">
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Transit
                                            </label>
                                            </div>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="status" id="flexRadioDefault1" value="langsung" checked>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Langsung
                                            </label>
                                            </div>
                    ...
                    <div class="modal-body">
                        <form method="post" action="transportasi.php">
                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="harga">Harga</label>
                                            <input type="text" class="form-control" name="harga" placeholder="Harga Total Penerbangan">
                                        </div>
                                        <div class="form-group">
                                            <label for="status">Status Transit</label>
                                            <div class="form-check">
