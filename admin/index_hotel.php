               ...
               ?> <tr>
                    ...
                    <td>
                        <div class="btn-group-vertical" style="display: flex; align-items: center;">
                            <a class="btn btn-success" href="edit_hotel.php?nama=<?php echo $row['id']?>"> Edit </a>
                            <a class="btn btn-danger" href="delete_hotel.php?id=<?php echo $row['id']?>" onClick="return confirm('Are you sure want to delete?')"> Delete </a>   
                        </div>
                    </td>
                    </tr>
                    <?php
