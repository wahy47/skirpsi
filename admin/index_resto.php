                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Rumah Makan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
               ...
               ?> <tr>
                    ...
                    <td>
                        <div class="btn-group-vertical" style="display: flex; align-items: center;">
                            <a class="btn btn-success" href="edit_resto.php?nama=<?php echo $row['id']?>"> Edit </a>
                            <a class="btn btn-danger" href="delete_resto.php?id=<?php echo $row['id']?>" onClick="return confirm('Are you sure want to delete?')"> Delete </a>   
                        </div>
                    </td>
                    </tr>
                    <?php
