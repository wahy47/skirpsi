...
if (isset($_POST['deleterental'])) {
    $idrtl = $_POST['deleterental'];
    $sqll = "SELECT * FROM rental WHERE id = '$idrtl'";
    $resultt = mysqli_query($db,$sqll);
    $dataa = $resultt -> fetch_assoc();
    if (!empty($dataa)) {
    $img ="../admin/images/".$dataa['gambar'];
    unlink($img);
    $sqlk = "DELETE FROM rental WHERE id = '$idrtl'";
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="text-end me-5">
            <a class="btn btn-success" href="upload_rental.php">
                <i class="fas fa-plus me-1"></i>Tambahkan Kendaraan
            </a>
        </div>             
               ...
               ?> <tr>
                    ...
                    <td>
                        <div class="btn-group-vertical" style="display: flex; align-items: center;">
                            <a class="btn btn-success" href="edit_rental.php?nama=<?php echo $row['id']?>"> Edit </a>
                            <form method="post">
                            <button class="btn btn-danger" name="deleterental" value="<?php echo $row['id'] ?>" onClick="return confirm('Are you sure want to delete?')"> Delete </button>
                            </form>   
                        </div>
                    </td>
                    </tr>
