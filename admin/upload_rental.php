        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            // Loop through file items
                ...
                // Add into MySQL database
                    if(!empty($sqlVal)) {
                    $insert = $db->query("INSERT INTO rental (gambar, nama, alamat, telepon, jenis, merek, harga) VALUES $sqlVal");
                    if($insert) {
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="container-fluid">
            <form method="post" action="upload_rental.php" enctype="multipart/form-data">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="card" style="width:700px; border-radius: 25px;">
                            <div class="card-header fs-1 text-center text-dark mt-2 mb-5" style="background-color: white;">
                                TAMBAHKAN KENDARAAN RENTAL
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="nama" placeholder="Masukkan Nama Tempat Rental">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="alamat_rental" placeholder="Masukkan Alamat Tempat Rental">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="no_telepon" placeholder="Masukkan Nomor Telepon Tempat Rental">
                                </div>
                                <div class="mb-3">
                                    <label for="jenis" class="form-label" style="font-size: 20px;
                                    font-weight: 100;">Jenis</label>
                                    <div class="form-check">
                                            ...
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="jenis" id="flexRadioDefault2" value="Motor">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="merek" placeholder="Masukkan Merek Kendaraan">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="harga" placeholder="Masukkan Harga Rental/hari">
                                </div>
                                <div class="mb-5 prev">
                                    <input type="file" id="ima" name="image" accept="image/png, image/jpg, image/jpeg" onchange="preview()">
