        ...
        if (!empty(array_filter($_FILES['image']['name']))) {
            ...
            foreach($_FILES['image']['name'] as $id=>$val){
                ...
                $uploadOk = 1;
                    ...
                    if(in_array($fileType, $allowedFileType)){
                        if(move_uploaded_file($tempLocation, $targetFilePath)){
                            $sqlVal = "('".$fileName."', '".$hotel."', '".$no_telepon."', '".$alamat_hotel."', '".$harga_standar."', '".$harga_deluxe."', '".$harga_superior."')";
                        } else {
                ...
                // Add into MySQL database
                    ...
                    if(!empty($sqlVal)) {
                    $insert = $db->query("INSERT INTO hotel_transit (gambar, nama_hotel, telepon, alamat,standar, deluxe, superior) VALUES $sqlVal");
                    if($insert) {
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="container-fluid">
            <form method="post" action="upload_hotel_transit.php" enctype="multipart/form-data">
                <div class="container">
