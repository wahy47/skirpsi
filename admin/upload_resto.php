...
if(isset($_POST['upload'])){
        ...
        if (!empty(array_filter($_FILES['image']['name']))) {
            ...
            foreach($_FILES['image']['name'] as $id=>$val){
                ...
                $alamat_resto    = $_POST['alamat_resto'];
                ...
                if ($cf == 0) {
                    ...
                    if(in_array($fileType, $allowedFileType)){
                        if(move_uploaded_file($tempLocation, $targetFilePath)){
                            $sqlVal = "('".$nama."', '".$fileName."', '".$deskripsi."', '".$harga_max."', '".$harga_min."', '".$alamat_resto."', '".$no_telepon."')";
                        } else {
                ...
                if ($cp == 0) {
                    $cp = $cp+1;
                    if(!empty($sqlVal)) {
                    $insert = $db->query("INSERT INTO rumah_makan (nama, gambar, deskripsi, harga_max, harga_min, alamat, telepon) VALUES $sqlVal");
                    if($insert) {
                ...
                if ($ct==0) {
                    $ct = $ct + 1;
                    $sqt ="('".$kat."')";
                    $sqlk = "UPDATE rumah_makan SET kategori=$sqt WHERE nama = '$objeks'";
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="container-fluid">
            <form method="post" action="upload_resto.php" enctype="multipart/form-data">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="card" style="width:700px; border-radius: 25px;">
                            <div class="card-header fs-1 text-center text-dark mt-2 mb-5" style="background-color: white;">
                                TAMBAHKAN RUMAH MAKAN
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="nama_resto" placeholder="Masukkan Nama Rumah Makan">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="alamat_resto" placeholder="Masukkan Alamat Rumah Makan">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="no_telepon" placeholder="Masukkan Nomor Telepon Rumah Makan">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="harga_max" placeholder="Masukkan Harga Tertinggi">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="formStyle" name="harga_min" placeholder="Masukkan Harga Terkecil">
                                </div>
                                <div class="mb-3">
                                    <textarea type="text" class="formStyle" name="deskripsi" placeholder="Masukkan Deskripsi Rumah Makan"></textarea>
                                </div>
                                <div class="mb-3">
        ...
        font-weight: 100;">Tambahkan Kategori</label>
                        ...
                        <?php
                        $sqlu = "SELECT * FROM kategori WHERE main IN ('kuliner','other')";
