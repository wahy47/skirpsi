<?php 
  ...
  $start = ($page - 1) * $limit;
  $result = $db->query("SELECT * FROM wisata LIMIT $start, $limit");
  $customers = $result->fetch_all(MYSQLI_ASSOC);

  $result1 = $db->query("SELECT count(id) AS id FROM wisata");
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="text-content">
                <h4>Recent Posts</h4>
                <h2>Destinasi Wisata Kepulauan Selayar</h2>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <nav aria-label="Page navigation">
                    <ul class="pagination">
                      ...
                      if ($page == 1) { ?>
                        ...
                        <a class="page-link" href="destinasi.php?page=<?= $Previous; ?>" aria-label="Previous">
                      ...
                      <?php for($i = 1; $i<= $pages; $i++){ ?>
                        <li class="page-item"><a class="page-link" href="destinasi.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                      <?php } ?>
                      <li class="page-item">
                        <a class="page-link" href="destinasi.php?page=<?= $Next; ?>" aria-label="Next">
