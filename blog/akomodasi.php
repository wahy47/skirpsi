<?php 
  ...
  $start = ($page - 1) * $limit;
  $result = $db->query("SELECT * FROM hotel LIMIT $start, $limit");
  $customers = $result->fetch_all(MYSQLI_ASSOC);

  $result1 = $db->query("SELECT count(id) AS id FROM hotel");
                  ...
                  <nav aria-label="Page navigation">
                    <ul class="pagination">
                      ...
                      if ($page == 1) { ?>
                        ...
                        <a class="page-link" href="akomodasi.php?page=<?= $Previous; ?>" aria-label="Previous">
                      ...
                      <?php for($i = 1; $i<= $pages; $i++){ ?>
                        <li class="page-item"><a class="page-link" href="akomodasi.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                      <?php } ?>
                      <li class="page-item">
                        <a class="page-link" href="akomodasi.php?page=<?= $Next; ?>" aria-label="Next">
